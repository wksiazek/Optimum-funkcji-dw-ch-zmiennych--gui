    ...
    ui(new Ui::MainWindow)
{
    ...
    ui-> lineEditY->setText("y");
    ui-> lineEditFitness->setText("f(x,y)");
    ...
    ui->doubleSpinBoxLeftBoundaryX->setMinimum(-1000);
    ui->doubleSpinBoxLeftBoundaryX->setMaximum(1000);
    ui->doubleSpinBoxRightBoundaryX->setMinimum(-1000);
    ui->doubleSpinBoxRightBoundaryX->setMaximum(1000);
    ui->doubleSpinBoxLeftBoundaryY->setMinimum(-1000);
    ui->doubleSpinBoxLeftBoundaryY->setMaximum(1000);
    ui->doubleSpinBoxRightBoundaryY->setMinimum(-1000);
    ui->doubleSpinBoxRightBoundaryY->setMaximum(1000);
    ui->spinBoxNumberBitsX->setValue(20);
    ui->spinBoxNumberBitsX->setMinimum(10);
    ui->spinBoxNumberBitsX->setMaximum(50);
    ui->spinBoxNumberBitsY->setValue(20);
    ui->spinBoxNumberBitsY->setMinimum(10);
    ui->spinBoxNumberBitsY->setMaximum(50);
    QPixmap pixmap;
...
int MainWindow::getSpinBoxNumberBitsX()
{
    return ui->spinBoxNumberBitsX->value();
}

int MainWindow::getSpinBoxNumberBitsY()
{
    return ui->spinBoxNumberBitsY->value();
}

double MainWindow::getDoubleSpinBoxLeftBoundaryX()
{
    return ui->doubleSpinBoxLeftBoundaryX->value();
}

double MainWindow::getDoubleSpinBoxRightBoundaryX()
{
    return ui->doubleSpinBoxRightBoundaryX->value();
}

double MainWindow::getDoubleSpinBoxLeftBoundaryY()
{
    return ui->doubleSpinBoxLeftBoundaryY->value();
}

double MainWindow::getDoubleSpinBoxRightBoundaryY()
{
    return ui->doubleSpinBoxRightBoundaryY->value();
}
...
void MainWindow::on_pushButtonStart_clicked()
{
    ...
    if(getDoubleSpinBoxLeftBoundaryX()==getDoubleSpinBoxRightBoundaryX() || getDoubleSpinBoxLeftBoundaryY()==getDoubleSpinBoxRightBoundaryY())
        QMessageBox::information(this,"Błąd w konfiguracji przedziału","Przedzial lewy nie może równać się przedziałowi prawemu");
    else if(getDoubleSpinBoxLeftBoundaryX()>getDoubleSpinBoxRightBoundaryX() ||getDoubleSpinBoxLeftBoundaryY()>getDoubleSpinBoxRightBoundaryY())
        QMessageBox::information(this,"Błąd w konfiguracji przedziału","Przedział lewy nie może być większy niż prawy");
    else
    {
    //ustalenie stalych
        Configuration::instance()->setParameters(getComboBoxOptimization(), 6, 1, getSpinBoxNumberBitsX(),
        getSpinBoxNumberBitsY(),getSpinBoxPopulationSize(),getSpinBoxNumberGeneration(),
        getSpinBoxProbabilityMutation(),getSpinBoxProbabilityCrossover(),getSpinBoxProbabilityInversion(),
        getSpinBoxPercentElite(),getComboBoxCrossoverAlgorithm(),getComboBoxMutationAlgorithm(),
        getComboBoxSelectionAlgorithm(),static_cast<int>(getComboBoxUniqueIndyvidual()),getSpinBoxPercentTheBestSelection(),
        getSpinBoxTournamentSize(), getComboBoxTypeScaled(), 2,getDoubleSpinBoxLeftBoundaryX(),
        getDoubleSpinBoxRightBoundaryX(),getDoubleSpinBoxLeftBoundaryY(),
        getDoubleSpinBoxRightBoundaryY(),getComboBoxTypeFunction());
        ...
        ui->lineEditX->setText(QString::number(alg.getWriter()->theBestIndyvidual(alg.getPopulation()).getScaledRepresentation10X()));
        ui->lineEditY->setText(QString::number(alg.getWriter()->theBestIndyvidual(alg.getPopulation()).getScaledRepresentation10Y()));
...
void MainWindow::on_comboBoxTypeFunction_currentIndexChanged(int index)
{
    ...
    QString c=".png";
    QString photography=a+b+c;

     if(!pixmap.load(photography))
