...
public:
    ...
    int getSpinBoxNumberBitsX();
    int getSpinBoxNumberBitsY();
    double getDoubleSpinBoxLeftBoundaryX();
    double getDoubleSpinBoxRightBoundaryX();
    double getDoubleSpinBoxLeftBoundaryY();
    double getDoubleSpinBoxRightBoundaryY();
